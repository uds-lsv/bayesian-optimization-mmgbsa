...
python experiments/run.py --out mcl1_mmpbsa_gb_batch --data  ./data/processed/MCL1-mmpbsa-gb_scores.csv --surrogate linear-empirical rf --embedding chemberta-mtr molformer fingerprint --sampler expected-improvement --n-iter  6 --protein  MCL1 --sample-size  600
python experiments/run.py --out mcl1_vina_batch --data  ./data/processed/MCL1-vina_scores.csv --surrogate linear-empirical rf --embedding chemberta-mtr molformer fingerprint --sampler expected-improvement --n-iter  6 --protein  MCL1 --sample-size  600
...
python experiments/run.py --out mcl1_vina --data  ./data/processed/MCL1-vina_scores.csv --surrogate linear-empirical rf --embedding chemberta-mtr molformer fingerprint --sampler expected-improvement --n-iter  3600 --protein  MCL1 --sample-size  1
python experiments/run.py --out mcl1_mmpbsa_gb --data  ./data/processed/MCL1-mmpbsa-gb_scores.csv --surrogate linear-empirical rf --embedding chemberta-mtr molformer fingerprint --sampler expected-improvement --n-iter  3600 --protein  MCL1 --sample-size  1
